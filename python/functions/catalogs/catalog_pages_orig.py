...
def extract_folio_pieces(row):
    ...
    if f_start is not None and f_end is not None:
        ...
        print('extract_folio_pieces', f_start, f_end, start_lst, end_lst, row['vol_order'])

        start_page_absolute, previous_page_num = get_page_numbers(f_start, start=True)
        end_page_absolute, *_ = get_page_numbers(f_end)

        # print(f'get_page_nums', f_start, previous_page_num, start_page_absolute, row['nlm_catalog'], row['vol_order'])
